  ...
  <body>
    ...
    >
      <div class="container-fluid">
        <img
          src="images/cdcd.jpg"  width="90em"  alt="cdcd"
        />
        ...
        >
          <div class="navbar-nav">
            ...
            <a class="nav-link text-success" href="compra.html"
              >Comprar tickets</a
            >
          </div>
        </div>
    ...
    <section class="pantalla_divida" id="lugar_fecha">
      <div class="secc1">
      </div>


    <div class="container-fluid pb-5" id="fecha">
      <div class="row align-items-center box">
          <div class="col-12 col-md-6" id="alineadoizq"></div>
          <div class="col-12 col-md-6 box__inner">
            <div class="container-flex">
              <img
                src="images/playa.jpg" class="secc1" alt="playa"
              />
            <div>
    ...
    <div class="container-fluid text-center" px-5 style="width: 65%">
      ...
      <div class="d-grid gap-2">
        <button class="btn btn-primary btn-enviar" type="button">
          Enviar
        </button>
      </div>
    </div>
